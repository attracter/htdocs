...
<div id="main" class="content djax-updatable <?php echo $classes; ?>">
	<?php
    if(wpgrade::option('portfolio_projects_filtering') == 1) {
	...
	<div class="mosaic <?php echo $mosaic_classes ?>" data-maxpages="<?php echo $query->max_num_pages ?>">
		...
		<div class="mosaic__item <?php echo $thumb_orientation; echo $has_post_thumbnail ? "" : " js--is-loaded "; echo lens::get_terms_as_string('lens_portfolio_categories', 'slug'); ?> mosaic__item--page-title-mobile">
		...
		<?php if ( $query->have_posts() ) :
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				<div class="mosaic__item <?php echo $thumb_orientation . ' '; if($categories) foreach($categories as $cat) { echo $cat->slug . ' '; } ?> ">
				...
				if ( $idx == 3 && wpgrade::option('portfolio_show_archive_title') && $paged == 1) : ?>
					<div class="mosaic__item  <?php echo $thumb_orientation; echo $has_post_thumbnail ? "" : " js--is-loaded "; echo lens::get_terms_as_string('lens_portfolio_categories', 'slug'); ?> mosaic__item--page-title">
						<div class="image__item-link">
							<div class="image__item-wrapper">
								<?php if ($has_post_thumbnail) : ?>
									<img
