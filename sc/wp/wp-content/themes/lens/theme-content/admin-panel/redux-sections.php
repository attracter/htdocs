...
$sections[] = array(
	...
	'icon_class'      => '',
	'class'           => 'has-customizer',
	'title'           => __( 'Colors', wpgrade::textdomain() ),
	'id'              => 'colors',
	'desc'            => '<p class="description">' . __( 'Using the color pickers you can change the colors of the most important elements. If you want to override the color of some elements you can always use Custom CSS code in Theme Options - Custom Code.', wpgrade::textdomain() ) . '</p>',
			...
			'customizer' => array(
				...
				'css_rules' => array(
					...
					'border-top-color' => array(
						'selector' => ".menu-item--main.current-menu-item:after,
...
$sections[] = array(
	...
	'icon_class'      => '',
	'class'           => 'has-customizer',
	'title'           => __( 'Backgrounds', wpgrade::textdomain() ),
	'id'              => 'backgrounds',
	'customizer_only' => true,
	'type' => 'customizer_panel',
	'fields'          => array( array('id' => 'legacy', 'title' => '', 'type' => 'info' ) )
...
$sections[] = array(
	...
	'icon_class'      => '',
	'class'           => 'has-customizer',
	'title'           => __( 'Typography', wpgrade::textdomain() ),
	'id'              => 'typography',
	'customizer_only' => true,
	'type' => 'customizer_panel',
	'fields'          => array( array('id' => 'legacy', 'title' => '', 'type' => 'info' ) )
...
//			'required'       => array( 'use_google_fonts', '=', 1 ),
			'title'          => '<button></button>' . __( 'Main Heading Font', wpgrade::textdomain() ),
		...
		array(
			...
			'google'         => true,
//			'required'       => array( 'use_google_fonts', '=', 1 ),
			'title'          => '<button></button>' . __( 'Body Font', wpgrade::textdomain() ),
		...
		array(
			...
			'google'         => true,
//			'required'       => array( 'use_google_fonts', '=', 1 ),
			'title'          => '<button></button>' . __( 'Menu Font', wpgrade::textdomain() ),
