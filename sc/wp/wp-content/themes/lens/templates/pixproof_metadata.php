	...
	<div id="pixproof_data" class="pixproof-data  push--bottom">
		<div class="row">
			...
			if ( ! empty( $event_date ) ) {
				...
				<div class="col-12  hand-col-3">
					<div class="entry__meta-box">
						<span class="meta-box__box-title"><?php _e( 'Event date', wpgrade::textdomain() ); ?></span>
			...
			if ( ! empty( $number_of_images ) ) {
				...
				<div class="col-12  hand-col-3">
					<div class="entry__meta-box">
						<span class="meta-box__box-title"><?php _e( 'Images', wpgrade::textdomain() ); ?></span>
			...
			if ( ! empty( $file ) ) { ?>
				<div class="col-12  hand-col-3">
					<div class="entry__meta-box">
						<button class="button-download  js-download  btn  btn--medium  btn--secondary" onclick="window.open('<?php echo $file; ?>')"><?php _e( 'Download', wpgrade::textdomain() ); ?></button>
					</div>
				</div>
			<?php } ?>
		</div>
