            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                echo '<div id="topper">';
                  echo '<div class="brand">';
                    echo '<img class="logothemeseagle" src="'. OT_URL . '/assets/images/custom/logo.png" >';
                  echo '</div>'; // end of brand
                  echo '<div class="option-tree-sub-header">';
                    echo '<div class="docs">';
                      echo '<ul>';
                        echo '<li>';
                          echo '<a href="'.get_template_directory_uri().'/includes/docs/index.html" target="_blank">';
                            echo '<img src="'. OT_URL . '/assets/images/custom/docs.png" >';
                          echo '</a>';
                        echo '</li>';
                        echo '<li>';
                          echo '<a href="http://www.themeseagle.com/support" target="_blank">';
                            echo '<img src="'. OT_URL . '/assets/images/custom/forum.png" >';
                          echo '</a>';
                        echo '</li>';
                        echo '<li>';
                          echo '<a href="http://www.youtube.com/user/ThemesEagle" target="_blank">';
                            echo '<img src="'. OT_URL . '/assets/images/custom/vidtuts.png" >';
                          echo '</a>';
                        echo '</li>';
                      echo '</ul>';
                      echo '<div class="buttons">';
                      if ( $show_buttons ) 
                  echo '<button class="option-tree-ui-button topper blue right">' . $page['button_text'] . '</button>';

                    echo '</div>'; // end of buttons
                    echo '</div>'; // end of docs
                  echo '</div>'; // end of subheader
                echo '</div>'; // end of topper
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button blue light left reset-settings" title="' . __( 'Reset Options', 'option-tree' ) . '">' . __( 'Reset Options', 'option-tree' ) . '</button>';
